...
void MyGLWidget::paintGL()
{
    ...
    // Activem el VAO per a pintar hommer
...
void MyGLWidget::creaBuffersTerra()
{
    ...
    glm::vec3 terra[6] =
        {
            glm::vec3(-1, -1, 1), //abaix esquerra cap a mi
            glm::vec3(1, -1, 1), //abaix dreta cap a mi
            glm::vec3(-1, -1, -1), //abaix esquerra cap a fora

            glm::vec3(-1, -1, -1), //abaix esquerra cap a fora
            glm::vec3(1, -1, 1), //abaix dreta cap a mi
            glm::vec3(1, -1, -1), //abaix dreta cap a fora
        };
...
{
    Model m;
    m.load("/home/albert/Documentos/UPC/Q4/IDI/Bloc2/s1/ej4/bloc-2/Model/HomerProves.obj");
