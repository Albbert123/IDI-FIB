...
class MyGLWidget : public BL2GLWidget {
  ...
  public slots:
    ...
    void lego(); //2
    void optica(); //3
    void changeEscala(int s); //4
    void changePsi(int p); //5
    void changeTheta(int t); //5
    void setColorTerra(int r, int g, int b); //6
    void setColorFons(int r, int g, int b); //7
    void setAmple(int x);
    void setAltura(int y);
  
  signals:
    void setPsi(int p); //5
    void setTheta(int t); //5
