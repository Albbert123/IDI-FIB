...
void MyGLWidget::creaBuffers () 
{
    ...
    m.load ("/home/albert/Documentos/UPC/Q4/IDI/Bloc2/s2/ex456/bloc-2/Model/Patricio.obj");
...
void MyGLWidget::modelTransform () //patricio
{
  // Matriu de transformació de model
  glm::mat4 transform (1.0f);
  transform = glm::rotate(transform, ang, glm::vec3(0.0, 1.0, 0.0));
  transform = glm::scale(transform, glm::vec3(escala)); 
  transform = glm::scale(transform, glm::vec3(4/altura, 4/altura, 4/altura)); //altura 4
